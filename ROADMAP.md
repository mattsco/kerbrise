...
> **#37 Offline PWA minimal — finalement fait**, malgré son classement ici. Livré le 29 juillet 2026 : six pages hors ligne calquées sur l'architecture en ligne, service worker écrit à la main sans dépendance, snapshot calendrier et profil en lecture seule avec bandeau de fraîcheur à 3 états. Validé sur iPhone (Safari, mode avion) ; l'éviction de stockage iOS et la PWA installée restent du best-effort documenté, pas une garantie. Détail : `CHANGELOG.md` + `docs/specs/pwa-offline-minimal.md`.
